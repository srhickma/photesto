...
window.onload = function(){
  if($(window).width() < 825){
    ...
    document.getElementById("forgotform").style.padding = "4px";
  }
  $.ajax({
      type:"GET",
      url:'/SGetUser.php',
...
$(document).ready(function(){
    ...
    $('#fpbtn').click(function(event){
        var usr = document.forgotform.usr.value;
        ...
        $.ajax({
            ...
            success:function(resp){
                removeLoader();
                if(resp === "S"){
                    document.getElementById("fpmsg").innerHTML = "Email successfully sent";
                    document.getElementById("fpmsg").style.color = "white";
                }
                else{
                    document.getElementById("fpmsg").innerHTML = resp;
                    document.getElementById("fpmsg").style.color = "red";
                }
            }
        });
    });
